---
name: save-as-skill
description: Turn a move you have done two or three times into a reusable skill, with an approval step. Use when you notice you are repeating the same multi-step process (a workflow, a prompt sequence, a check). Creates a new skill in .Codex/skills/ so the next run is one command.
---
...
5. Write it to .Codex/skills/{skill-name}/SKILL.md.
