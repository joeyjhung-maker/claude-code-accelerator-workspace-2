...
If packaging for another builder (Codex, Codex, a design tool), write a
...
- `builder-prompt`: prompt and package for Codex, Codex, Cursor, or
  another builder.
