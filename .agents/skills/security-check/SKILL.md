---
name: security-check
description: Run before installs, public sharing, client work, GitHub backup, bypass permissions, or risky file edits. Checks for secrets, dangerous commands, private data, public exposure, dependency/install risk, and rollback state. Produces a short approve/fix/stop recommendation before Codex acts.
---
