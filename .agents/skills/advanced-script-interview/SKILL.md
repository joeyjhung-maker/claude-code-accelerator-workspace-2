...
description: Run after Obsidian is installed and the link map works. Interviews the operator more deeply, then proposes a careful AGENTS.md and support-file update plan. Keeps AGENTS.md thin, routes detail into the right folders, and waits for approval before editing.
---
...
`AGENTS.md` should hold only the durable operating rules Codex needs at the start of most sessions. Details, examples, client facts, swipes, proof, and workflows belong in support files.
...
1. What do you use Codex for most often?
...
6. When should Codex decide, and when should Codex ask first?
...
11. Which tools, folders, websites, credentials, or client materials should Codex treat carefully?
12. What should Codex do at the end of a session so the workspace compounds?
...
- Keep `AGENTS.md` readable and short.
...
- If a detail is useful but too specific for `AGENTS.md`, route it into the right support file and leave only a pointer in the Script.
...
- what the operator should test in the next Codex session
