---
name: convince-me
description: A verification gate. Before Codex acts on an important step, it restates what it is about to do and why in plain language, so you catch a misunderstanding before it executes. After a big step, it explains what changed. Use on anything where a confident wrong move would cost you.
---

# Convince Me

Catches the most common failure: Codex confidently doing the wrong thing. Cheap insurance on work that matters.
