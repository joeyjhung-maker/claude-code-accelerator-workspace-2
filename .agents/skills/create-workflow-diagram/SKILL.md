...
- "Find leads on Apollo → Enrich with Clay → Qualify with Codex → Send to Smartlead"
...
- (Free text input)
- Examples:
  - "1. Find leads on Apollo → 2. Enrich with Clay → 3. Qualify with Codex → 4. Send to Smartlead"
...
```
Input: "1. Find leads on Apollo → 2. Enrich with Clay → 3. Qualify with Codex → 4. Send to Smartlead via API"

Parsed:
nodes:
  - id: 1, label: "Find leads", detail: "Apollo", icon: "🔍"
  - id: 2, label: "Enrich leads", detail: "Clay", icon: "✨"
  - id: 3, label: "Qualify leads", detail: "Codex", icon: "🤖"
...
<body>
    ...
    <div class="diagram-subtitle">Apollo → Clay → Codex → Smartlead</div>
...
1. User: "Create a diagram for: Find leads on Apollo → Enrich with Clay → Qualify with Codex → Send to Smartlead"
