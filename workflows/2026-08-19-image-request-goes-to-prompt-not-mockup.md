...
`creatives/flexxable/b2b-gifts-about-page-chatgpt-prompt.md` — one prompt block, 1920x1080 (matched to the real Skool About-page slot), real Money Bags campaign numbers, no invented stats.
